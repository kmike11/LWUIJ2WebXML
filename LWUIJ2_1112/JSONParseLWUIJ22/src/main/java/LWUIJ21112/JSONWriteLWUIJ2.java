...
public class JSONWriteLWUIJ2 {

    public static void main(String[] args) {
        try (FileReader reader = new FileReader("src/main/resources/orarendLWUIJ2.json")){
            JSONParser parser = new JSONParser();
            JSONObject object = (JSONObject) parser.parse(reader);

            JSONObject root = (JSONObject) object.get("KM_orarend");
            ...
            output.put("KM_orarend", outputArr);

            try(FileWriter writer = new FileWriter("src/main/resources/orarendLWUIJ21.json")) {
